...
export default function App() {
  ...
  function answer(response) {
    ...
    if (questionIndex + 1 < qs.length) setQuestionIndex((i) => i + 1);
    else next();
    scrollToTop();
  }
